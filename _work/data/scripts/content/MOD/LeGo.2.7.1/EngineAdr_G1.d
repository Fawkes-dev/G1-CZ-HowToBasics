...
/*
//-->
	var string fontNameCache[255];
	var int fontCache[255];
	...
	while (i < cached);
		if (Hlp_StrCmp (font, MEM_ReadStringArray (_@s (fontNameCache), i))) {
			f = MEM_ReadIntArray (_@ (fontCache), i);
			break;
		};
		i += 1;
	end;
	...
	MEM_WriteStringArray (_@s (fontNameCache), i, font);
	MEM_WriteIntArray (_@ (fontCache), i, f);
