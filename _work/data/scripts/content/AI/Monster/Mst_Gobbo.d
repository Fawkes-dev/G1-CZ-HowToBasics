...
func void Set_GreenGobbo_Visuals(){	Mdl_SetVisual(self,"Gobbo.mds");
	Mdl_SetVisualBody(self,"Gob_Body",0,DEFAULT,"",DEFAULT,DEFAULT,-1);
};

instance GreenGobboClub(Mst_Default_GreenGobbo){	Set_GreenGobbo_Visuals();
	fight_tactic = FAI_MONSTER_COWARD;
	Npc_SetToFightMode(self,ItMw_1H_Club_01);
	attribute[ATR_STRENGTH] = attribute[ATR_STRENGTH] + 5;
};

instance GreenGobboSword(Mst_Default_GreenGobbo){	Set_GreenGobbo_Visuals();
